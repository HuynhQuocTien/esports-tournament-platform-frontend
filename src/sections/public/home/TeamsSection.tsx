...
import { TeamOutlined, TrophyOutlined, GlobalOutlined } from "@ant-design/icons";
        ...
        {teams.map((t) => (
          <Col xs={24} sm={12} lg={6} key={t.id}>
            ...
            >
              ...
              >
                <Space size={16} style={{ width: "100%", justifyContent: "space-around" }}>
                  <div style={{ textAlign: "center" }}>
                    <TrophyOutlined style={{ color: "#52c41a", display: "block", marginBottom: "4px" }} />
                    <Text style={{ color: "#52c41a", fontWeight: 600, fontSize: "14px" }}>{t.wins}</Text>
                    <Text style={{ color: "#999999", fontSize: "11px", display: "block" }}>Thắng</Text>
                  </div>
                  <div style={{ textAlign: "center" }}>
                    <TeamOutlined style={{ color: "#ff4d4f", display: "block", marginBottom: "4px" }} />
                    <Text style={{ color: "#ff4d4f", fontWeight: 600, fontSize: "14px" }}>{t.losses}</Text>
                    <Text style={{ color: "#999999", fontSize: "11px", display: "block" }}>Thua</Text>
                  </div>
                </Space>
              </div>
            </Card>
